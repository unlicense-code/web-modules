import type { OpenFileOption, ProjectDependencies, ProjectFiles, UiThemeOption, UiViewOption } from './stackblitz-project-interfaces';
...
export declare class VM {
    ...
    preview: {
         ...
         * In WebContainers-based projects, 
         * ignored if running web server.
         *
         * @since 1.7.0
         * @experimental
         */
